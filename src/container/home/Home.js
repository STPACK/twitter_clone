...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    likeTweet: (key, uid, method) =>dispatch(actions.likeTweet(key, uid, method)),
    reTweet :(key, uid, method) =>dispatch(actions.reTweet(key, uid, method)),
  };
};
